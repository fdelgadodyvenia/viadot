...
Connector to have access to Supermetrics, which is a tool to have access to different
data sources.

This module provides functionalities to have access to Supermetrics data. It includes
the following features:
- Credential Management
- Data Source Data Collection

Classes:
    SupermetricsCredentials(BaseModel): Description of Class1.
    Supermetrics: Supermetrics connector to fetch data.
"""
...
class SupermetricsCredentials(BaseModel):
    """
    Supermetrics Classes to record the credentials.
